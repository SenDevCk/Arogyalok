...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        if (Build.VERSION.SDK_INT >= 23 && (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED
            ...
            ActivityCompat.requestPermissions(WebView.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE,
...
//                }
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onCreateWindow(android.webkit.WebView view, boolean isDialog, boolean isUserGesture, Message resultMsg) {
                android.webkit.WebView newWebView = new android.webkit.WebView(WebView.this);

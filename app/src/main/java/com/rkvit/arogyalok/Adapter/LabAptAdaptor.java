...
import com.rkvit.arogyalok.Fragments.LabHisDetails;
...
public class LabAptAdaptor extends RecyclerView.Adapter<LabAptAdaptor.MyViewHlder> {
    private final int limit = 5;
    private Activity activity;
    private List<LabHistoryModel> list;
    private View view;
    ...
    public LabAptAdaptor(Activity activity, List<LabHistoryModel> list, HashMap<String, String> hashSpecList, String viewLayout) {
    ...
    public void setDataList(List<LabHistoryModel> dataList, HashMap<String, String> hashSpecList) {
        list = dataList;
        this.hashSpecList = hashSpecList;
...
//        Toast.makeText(activity, String.valueOf(list.size()) + " Hotel Found", Toast.LENGTH_SHORT).show();
    ...
    public void setFilter(List<LabHistoryModel> FilteredDataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHlder myViewHlder, final int i) {
        ...
        myViewHlder.Date.setText(list.get(i).getDop());
        ...
        myViewHlder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences pref = activity.getSharedPreferences("LabHisDetails", Context.MODE_PRIVATE);

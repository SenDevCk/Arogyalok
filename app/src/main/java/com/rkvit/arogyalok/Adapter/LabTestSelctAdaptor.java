...
public class LabTestSelctAdaptor extends RecyclerView.Adapter<LabTestSelctAdaptor.MyViewHlder> {
    ...
    public LabTestSelctAdaptor(Activity activity, List<TestDetailsModel> list, HashMap<String, String> hashTestList, LabDetails fragment) {
    ...
    public void onBindViewHolder(@NonNull MyViewHlder myViewHlder, final int i) {
        ...
        myViewHlder.Mrp.setText("Fees: " + "\u20B9" + list.get(i).getTestFees());

...
public class MedAdaptor extends RecyclerView.Adapter<MedAdaptor.MyViewHlder> {
    ...
    public MedAdaptor(Activity activity, List<MedListModel> list, MedicineFragment fragment) {
        this.activity = activity;
        this.list = list;
        this.fragment = fragment;
    }

    public MedAdaptor(Activity activity, List<MedListModel> list) {
        this.activity = activity;
        this.list = list;
//        this.fragment = fragment;
    }

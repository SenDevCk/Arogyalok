...
public class MedHomeAdaptor extends RecyclerView.Adapter<MedHomeAdaptor.MyViewHlder> {
    ...
    public MedHomeAdaptor(Activity activity, List<MedListModel> list, MedicineFragment fragment) {
        this.activity = activity;
        this.list = list;
        this.fragment = fragment;
    }

    public MedHomeAdaptor(Activity activity, List<MedListModel> list) {
        this.activity = activity;
        this.list = list;
//        this.fragment = fragment;
    }

...
import com.rkvit.arogyalok.Fragments.LabSchemeDetails;
...
public class SchemHomeAdaptor extends RecyclerView.Adapter<SchemHomeAdaptor.MyViewHlder> {
    ...
    public SchemHomeAdaptor(Activity activity, List<LabSchemModel> list, HashMap<String, String> hashTestList) {
    ...
    public MyViewHlder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.schem_home_list_layout, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHlder myViewHlder, final int i) {
        ...
        double MRP = Double.parseDouble(list.get(i).getTotalPrice());
        double SP = Double.parseDouble(list.get(i).getFinalPrice());
        double diff = MRP - SP;
        ...
        myViewHlder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SharedPreferences pref = activity.getSharedPreferences("LabSchemeDetails", Context.MODE_PRIVATE);
                pref.edit().putString("id", list.get(i).getId())
                        .putString("lab_id", list.get(i).getLabId())
                        .putString("name", list.get(i).getSkimName())
                        .putString("img", list.get(i).getImage())
                        .putString("test_name", myViewHlder.testName.getText().toString())
                        .putString("total_price", list.get(i).getTotalPrice())
                        .putString("discount_price", list.get(i).getDiscountPrice())
                        .putString("final_price", list.get(i).getFinalPrice())
                        .putString("skim_validity", list.get(i).getSkimValidity())
                        .putString("description", list.get(i).getDescription())
                        .apply();

                AppCompatActivity activity = (AppCompatActivity) view.getContext();
                Fragment myFragment = new LabSchemeDetails();

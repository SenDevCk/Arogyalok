...
public class BloodFilterValuesAdapter extends RecyclerView.Adapter<BloodFilterValuesAdapter.MyViewHolder> {

    private Context context;
    private Integer filterIndex;

    public BloodFilterValuesAdapter(Context context, Integer filterIndex) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int position) {
        final BloodFilter tmpHotelFilter = BloodFilterPreferences.filters.get(filterIndex);
        myViewHolder.value.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BloodFilterPreferences.filters.put(filterIndex, tmpHotelFilter);
    ...
    public int getItemCount() {
        return BloodFilterPreferences.filters.get(filterIndex).getValues().size();
    }

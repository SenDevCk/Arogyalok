...
public class DocFilterValuesAdapter extends RecyclerView.Adapter<DocFilterValuesAdapter.MyViewHolder> {

    private Context context;
    private Integer filterIndex;

    public DocFilterValuesAdapter(Context context, Integer filterIndex) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int position) {
        final DocFilter tmpHotelFilter = DocFilterPreferences.filters.get(filterIndex);
        myViewHolder.value.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DocFilterPreferences.filters.put(filterIndex, tmpHotelFilter);
    ...
    public int getItemCount() {
        return DocFilterPreferences.filters.get(filterIndex).getValues().size();
    }

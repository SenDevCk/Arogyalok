...
public class LabFilterAdapter extends RecyclerView.Adapter<LabFilterAdapter.MyViewHolder> {

    private Context context;
    private HashMap<Integer, LabFilter> filters;
    private RecyclerView filterValuesRV;
    private int selectedPostion = 0;

    public LabFilterAdapter(Context context, HashMap<Integer, LabFilter> filters, RecyclerView filterValuesRV) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int position) {
        myViewHolder.container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                filterValuesRV.setAdapter(new LabFilterValuesAdapter(context, position));
                selectedPostion = position;
                notifyDataSetChanged();
            }
        });

        filterValuesRV.setAdapter(new LabFilterValuesAdapter(context, selectedPostion));

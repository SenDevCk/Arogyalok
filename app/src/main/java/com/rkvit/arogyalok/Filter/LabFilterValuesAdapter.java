...
public class LabFilterValuesAdapter extends RecyclerView.Adapter<LabFilterValuesAdapter.MyViewHolder> {

    private Context context;
    private Integer filterIndex;

    public LabFilterValuesAdapter(Context context, Integer filterIndex) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int position) {
        final LabFilter tmpHotelFilter = LabFilterPreferences.filters.get(filterIndex);
        myViewHolder.value.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LabFilterPreferences.filters.put(filterIndex, tmpHotelFilter);
    ...
    public int getItemCount() {
        return LabFilterPreferences.filters.get(filterIndex).getValues().size();
    }

...
public class WebLoginFragment extends Fragment {
    ...
    public static WebLoginFragment newInstance(String param1, String param2) {
...
//        UserPassword = pref.getString("password", null);
        ...
        SharedPreferences pref = getActivity().getSharedPreferences("Weblogin", MODE_PRIVATE);
        Url = pref.getString("type", null);
...
////
    ...
    /*private class SSLTolerentWebViewClient extends WebViewClient {
        public void onReceivedSslError(com.rkvit.arogyalok.Activity.WebView view, final SslErrorHandler handler, SslError error) {
